			...
			<form id="addForm" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<div class="preview-image" style="margin-top: 10px;"></div>
					</div>
				</div>
            </div> 
			</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<input type="hidden" id="delimage">
			</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <button type="button" class="btn btn-danger" onclick="$('#delid').click();"><span class="glyphicon glyphicon-trash"></span> Yes</button>
            </div>
        </div>
    </div>
</div>
